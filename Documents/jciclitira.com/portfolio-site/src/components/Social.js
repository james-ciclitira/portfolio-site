...
<div className='mt5'>
        <a className="link dim round dib h2 w2  mr3 pa2 grow" target='blank' href="https://twitter.com/jamesciclitira" title='Twitter'>
          <svg data-icon="twitter" viewBox="0 0 32 32" style={{fill: '#353F41'}}>
        ...
        <a className="link dim round dib h2 w2  mr3 pa2 grow"  target='blank' href="https://github.com/james-ciclitira" title='Github'>
          <svg data-icon="github" viewBox="0 0 32 32" style={{fill: '#353F41'}}>
        ...
        <a className="link dim round dib h2 w2  mr3 pa2 grow"  target='blank' href="https://www.linkedin.com/in/jciclitira/" title='LinkedIn'>
          <svg x="0px" y="0px" viewBox="0 0 48 48" style={{fill: '#353F41'}}> >
          <path fill="#353F41" d="M48,42c0,3.313-2.687,6-6,6H6c-3.313,0-6-2.687-6-6V6 c0-3.313,2.687-6,6-6h36c3.313,0,6,2.687,6,6V42z"
          ></path>
          <g >
            <g >
        ...
        <svg x="0px" y="0px" viewBox="0 0 32 32" fill="#353F41">
